...
<?php //var_dump($address); ?>
    ...
    <form action="" method="post">
        <table class="form-table">
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <textarea name="address" id="address" cols="10" rows="5" class="regular-text"><?php echo esc_textarea( $address->address ); ?></textarea>
                    </td>
                </tr>
        ...
        <?php submit_button( __('Update Address', 'wedevs-acdemy'), 'primary', 'submit_address' ); ?>
    </form>
</div>